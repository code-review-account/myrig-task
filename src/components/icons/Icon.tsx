...
export function BasketIcon() {
    return (
        <div className='icon-wrap icon-wrap--basket'>
            <svg className='icon' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 23 24">
...
export function PencilIcon() {
    return (
        <div className='icon-wrap icon-wrap--pencil'>
            <svg className='icon' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 24">
